...
execute_process(
  COMMAND "/usr/local/bin/git" show-ref "703bd9caab50b139428cea1aaff9974ebee5742e"
  WORKING_DIRECTORY "/Users/christophercheung/Desktop/6.830/830final/build/googletest-src"
...
if("${show_ref_output}" MATCHES "refs/remotes/703bd9caab50b139428cea1aaff9974ebee5742e")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "703bd9caab50b139428cea1aaff9974ebee5742e")
  set(git_remote "${CMAKE_MATCH_1}")
  set(git_tag "${CMAKE_MATCH_2}")
else()
  set(git_remote "origin")
  set(git_tag "703bd9caab50b139428cea1aaff9974ebee5742e")
endif()
    ...
    if("REBASE" STREQUAL "CHECKOUT")
      ...
      if(error_code)
        ...
        if(NOT "REBASE" STREQUAL "REBASE_CHECKOUT")
          ...
          message(FATAL_ERROR "\nFailed to rebase in: '/Users/christophercheung/Desktop/6.830/830final/build/googletest-src'."
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/christophercheung/Desktop/6.830/830final/build/googletest-src'."
                              "\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
